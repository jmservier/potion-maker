    ...
    >
      ...
      <ScrollArea className="h-[300px]">
        {discoveredRecipes.length === 0 ? (
          <div className="py-8 text-center text-sm" style={{ color: '#8b4513' }}>
          ...
          <div className="space-y-3">
            {discoveredRecipes.map((recipe) => (
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(255, 255, 255, 0.9) 0%, rgba(245, 230, 211, 0.6) 100%)',
                  border: '1px solid rgba(210, 180, 140, 0.3)'
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = 'rgba(160, 82, 45, 0.4)';
                  e.currentTarget.style.boxShadow = '0 6px 20px rgba(160, 82, 45, 0.15)';
                  e.currentTarget.style.background = 'linear-gradient(135deg, rgba(255, 255, 255, 1) 0%, rgba(245, 230, 211, 0.8) 100%)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = 'rgba(210, 180, 140, 0.3)';
                  e.currentTarget.style.boxShadow = 'none';
                  e.currentTarget.style.background = 'linear-gradient(135deg, rgba(255, 255, 255, 0.9) 0%, rgba(245, 230, 211, 0.6) 100%)';
                }}
              >
                <h3 className="mb-2 font-semibold" style={{ color: '#3d2914' }}>{recipe.name}</h3>
